let sliderHTML =
  ...
  <div id="slider-pic" class="h-screen basis-2/3 duration-500">
    <div class="h-full w-full bg-hero-eagle bg-cover bg-center bg-no-repeat"></div>
    <div class="h-full w-full bg-hero-castle bg-cover bg-center bg-no-repeat"></div>
    <div class="h-full w-full bg-hero-sky bg-cover bg-center bg-no-repeat"></div>
    <div class="h-full w-full bg-hero-flower bg-cover bg-center bg-no-repeat"></div>
  </div>
</section>`;
